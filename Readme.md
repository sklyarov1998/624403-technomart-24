...
* Студент: [Даниэль Скляров](https://up.htmlacademy.ru/htmlcss/24/user/624403).
* Наставник: `Anton Ignatenko`.
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/624403-technomart-24) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
